              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    const Text(
                      "Information",
                      style: TextStyle(fontFamily: "Average",fontSize: 24),
                    ),
                ...
                ProfileCard(title: profile.email, icon: Icons.mail_outline_outlined),
                ProfileCard(title: profile.phoneNumber, icon: Icons.phone_outlined),
